...
if _ENV_UNIFIED:
    # benutze exakt den ENV-Pfad (kann absolut oder relativ zum Container-CWD sein)
    NOTIFIER_UNIFIED = _ENV_UNIFIED
else:
    NOTIFIER_UNIFIED = str(PROFILE_DIR / "notifier.json")  # sauberer lokaler Fallback

# Für UI-Kompatibilität: historischer Alias
